...
export const secondaryButtonClass =
  'flex items-center gap-1.5 rounded-md border border-[var(--cab-text)]/20 px-2.5 py-1.5 text-[13px] text-[var(--cab-text)]/80 transition-colors hover:bg-white/6 disabled:opacity-50'
...
export const formPanelStyle = {
  background: 'color-mix(in srgb, var(--plasma-color) 7%, var(--cab-panel-form))',
