import type { CubeFaceDefinition, FaceName } from '../../types/navigation.tsx'
import { SITE_NAME, LOGO_IMAGE_PATH } from '../site/site.tsx'
...
export const cubeFaceDefinitions: CubeFaceDefinition[] = [
  {
    ...
    label: '',
    ariaLabel: `Авторизация — ${SITE_NAME}`,
  },
  {
    name: 'back',
    iconHtml:
...
/** Неоновый цвет, закреплённый за каждой гранью — используется и кубом, и подменю. */
export const faceColors: Record<FaceName, string> = {
  front: '#0ff',
  back: '#f0f',
  right: '#0f8',
  left: '#f80',
